...
ChromeAndroid.prototype.configure = function (args, caps, cb) {
  ...
  if (app === "chromium") {
    logger.debug("Using Chromium packages");
    this.args.androidPackage = "org.chromium.chrome.shell";
    this.args.androidActivity = ".ChromeShellActivity";
  } else if (app === "chromebeta") {
    logger.debug("Using Chrome Beta packages");
    this.args.androidPackage = "com.chrome.beta";
    this.args.androidActivity = "com.google.android.apps.chrome.Main";
  } else if (app === "browser") {
    logger.debug("Using Browser packages");
    this.args.androidPackage = "com.android.browser";
    this.args.androidActivity = "com.android.browser.BrowserActivity";
  } else if (app === "samsungbrowser") {
    logger.debug("Using Samsung Browser packages");
    this.args.androidPackage = "com.sec.android.app.sbrowser";
    this.args.androidActivity = "com.sec.android.app.sbrowser.SBrowserMainActivity";
  } else {
    logger.debug("Using default Chrome packages");
