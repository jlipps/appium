...
import { DriverConfig, DRIVER_TYPE, PLUGIN_TYPE } from './extension-config';
...
async function preflightChecks ({parser, args, driverConfig, throwInsteadOfExit = false}) {
  try {
    checkNodeOk();
...
async function main (args = null) {
  ...
  appiumDriver.driverConfig.print();
